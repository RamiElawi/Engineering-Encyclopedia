...
router.post('/addSTL',isAuth,upload.fields([{name:'STL'},{name:'images'},{name:'file'}]),stlController.addSTL);

router.post('/updateSTL/:stlId',isAuth,upload.fields([{name:'STL'},{name:'images'},{name:'file'}]),stlController.updateSTL);
